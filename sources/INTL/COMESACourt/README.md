...
**Source:** [https://comesacourt.org/](https://comesacourt.org/)
**Country:** INTL
**Data types:** case_law
**Status:** Blocked
...
**Technical reason:** `scanned_pdfs_need_ocr`

**Details:** Re-blocked: original issue (scanned_pdfs_need_ocr) not solvable by PDF extraction alone
