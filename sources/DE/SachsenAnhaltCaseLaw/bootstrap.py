#!/usr/bin/env python3
"""
DE/SachsenAnhaltCaseLaw - Sachsen-Anhalt State Court Decisions

Fetches court decisions from the official Sachsen-Anhalt Landesrecht portal via the
juris jPortal REST API.

Coverage:
- ~13K court decisions from all Sachsen-Anhalt court branches
- VG, OVG, LG, OLG, AG, LAG, LSG, SG, FG, and constitutional court
- Decisions from 2000s onward

Data source: https://landesrecht.sachsen-anhalt.de/bsst/
