#!/usr/bin/env python3
"""
DE/RheinlandPfalzCaseLaw - Rheinland-Pfalz State Court Decisions

Fetches court decisions from the official Rheinland-Pfalz Landesrecht portal via the
juris jPortal REST API.

Coverage:
- ~12K court decisions from all Rheinland-Pfalz court branches
- VG, OVG, LG, OLG, AG, LAG, LSG, SG, FG, and constitutional court
- Decisions from 2000s onward

Data source: https://landesrecht.rlp.de/bsrp/
...
SOURCE_ID = "DE/RheinlandPfalzCaseLaw"
PAGE_SIZE = 25
