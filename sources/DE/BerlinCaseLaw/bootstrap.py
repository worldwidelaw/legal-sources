#!/usr/bin/env python3
"""
DE/BerlinCaseLaw - Berlin State Court Decisions

Fetches court decisions from the official Berlin Landesrecht portal via the
juris jPortal REST API.

Coverage:
- ~29K court decisions from all Berlin court branches
- VG, OVG, LG, OLG, AG, LAG, LSG, SG, FG, and constitutional court
- Decisions from 2000s onward

Data source: https://gesetze.berlin.de/bsbe/
