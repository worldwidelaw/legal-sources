#!/usr/bin/env python3
"""
DE/SaarlandCaseLaw - Saarland State Court Decisions

Fetches court decisions from the official Saarland Landesrecht portal via the
juris jPortal REST API.

Coverage:
- ~7K court decisions from all Saarland court branches
- VG, OVG, LG, OLG, AG, LAG, LSG, SG, FG, and constitutional court
- Decisions from 2000s onward

Data source: https://recht.saarland.de/bssl/
