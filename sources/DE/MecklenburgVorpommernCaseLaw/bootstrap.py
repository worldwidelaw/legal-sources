#!/usr/bin/env python3
"""
DE/MecklenburgVorpommernCaseLaw - Mecklenburg-Vorpommern State Court Decisions

Fetches court decisions from the official Mecklenburg-Vorpommern Landesrecht portal via the
juris jPortal REST API.

Coverage:
- ~5K court decisions from all Mecklenburg-Vorpommern court branches
- VG, OVG, LG, OLG, AG, LAG, LSG, SG, FG, and constitutional court
- Decisions from 2000s onward

Data source: https://www.landesrecht-mv.de/bsmv/
...
SOURCE_ID = "DE/MecklenburgVorpommernCaseLaw"
PAGE_SIZE = 25
