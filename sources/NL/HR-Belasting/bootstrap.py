#!/usr/bin/env python3
"""
NL/HR-Belasting - Dutch Supreme Court Tax Chamber (Hoge Raad - Belastingkamer)

Fetches tax case law from the Hoge Raad via the Rechtspraak Open Data API.
Filters by creator (Hoge Raad) and subject (belastingrecht).

The Tax Chamber of the Hoge Raad is the court of last resort for tax cases.
...
# Constants
SOURCE_ID = "NL/HR-Belasting"
COURT_NAME = "Hoge Raad der Nederlanden"
COURT_URI = "http://standaarden.overheid.nl/owms/terms/Hoge_Raad_der_Nederlanden"
SUBJECT_URI = "http://psi.rechtspraak.nl/rechtsgebied#bestuursrecht_belastingrecht"
