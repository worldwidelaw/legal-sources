...
Document types:
  - guidance: ~123 practice guides (publications)
  - detailed_guide: ~145 guides (inline body)
  - statutory_guidance: ~5 documents

Coverage: ~273 documents with full HTML text.
...
logger = logging.getLogger("UK/HMLR")

# GOV.UK Content API base
BASE_URL = "https://www.gov.uk"

# GOV.UK organisation slug for HM Land Registry
ORG_SLUG = "land-registry"
...
class UKHMLRScraper(BaseScraper):
    """
    Scraper for UK HM Land Registry documents via GOV.UK Content API.
    ...
    def _search_documents(self, doc_type: str, start: int = 0, count: int = 50) -> dict:
        """Search GOV.UK for Land Registry documents of a given type."""
        params = (
    ...
    def _extract_full_text(self, content_data: dict) -> str:
        ...
        # For detailed_guide / html_publication, body is inline
        ...
        if schema == "publication":
            ...
            # Check documents field for embedded attachment links
    ...
    def fetch_all(self) -> Generator[dict, None, None]:
        """Yield all Land Registry documents with full text."""
