...
Coverage: ~958 documents with full HTML text.
...
logger = logging.getLogger("UK/MCA")

BASE_URL = "https://www.gov.uk"
ORG_SLUG = "maritime-and-coastguard-agency"
...
class UKMCAScraper(BaseScraper):
    """Scraper for UK MCA documents via GOV.UK Content API."""
    ...
    def _search_documents(self, doc_type: str, start: int = 0, count: int = 50) -> dict:
        """Search GOV.UK for MCA documents of a given type."""
        params = (
    ...
    def fetch_all(self) -> Generator[dict, None, None]:
        """Yield all MCA documents with full text."""
