...
Coverage: ~132 documents (reports, guidance, statistics, consultations)
...
logger = logging.getLogger("UK/Ofgem")
...
class UKOfgemScraper(BaseScraper):
    """
    Scraper for UK Ofgem publications on GOV.UK.

    Strategy:
    - Use GOV.UK Search API to list all Ofgem documents (paginated)
    ...
    def _search_page(self, start: int = 0) -> dict:
        """Fetch one page of Ofgem documents from GOV.UK Search API."""
        params = {
    ...
    def fetch_all(self) -> Generator[dict, None, None]:
        """Yield all Ofgem documents from GOV.UK."""
        start = 0
        total = None
        fetched = 0
        ...
        while True:
            ...
            if total is None:
                ...
                logger.info(f"Total Ofgem documents on GOV.UK: {total}")
