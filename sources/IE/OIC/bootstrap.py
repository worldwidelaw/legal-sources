...
of the Information Commissioner (OIC, oic.ie), the independent statutory office
that reviews decisions made by public bodies under the Freedom of Information
Act 2014 (and, for environmental information, the AIE Regulations). Each
published decision determines whether a public body was justified in its
handling of an access request and is a formal, binding adjudication on a
specific case = case_law.

Strategy:
  1. Enumerate every decision by paging the server-rendered decisions listing:
         https://oic.ie/en/decisions/?page=N
     Each page lists 10 decisions as /en/ombudsman-decision/{slug}/ links.
     (The listing runs ~346 pages -> ~3,460 decisions.)
...
logger = logging.getLogger("legal-data-hunter.IE.OIC")

BASE_URL = "https://oic.ie"
LIST_PATH = "/en/decisions/"
DETAIL_PREFIX = "/en/ombudsman-decision/"
MAX_PAGES = 500  # safety ceiling; real corpus is ~346 pages
...
class OICScraper(BaseScraper):
    """Scraper for Irish Information Commissioner FOI/AIE review decisions."""
    ...
    def fetch_all(self) -> Generator[Dict[str, Any], None, None]:
        ...
        if not any_item:
            raise RuntimeError(
                "OIC decisions listing returned 0 usable decisions — "
    ...
    def normalize(self, raw: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        uid = case_no or slug
        title = title_raw or f"OIC Decision {case_no or slug}"
        ...
        return {
            ...
            "authority": "Office of the Information Commissioner (Ireland)",
            "jurisdiction": "IE",
            "language": "en",
        }

    def test_connection(self):
        print("Testing OIC decisions listing...")
