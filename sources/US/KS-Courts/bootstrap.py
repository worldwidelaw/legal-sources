#!/usr/bin/env python3
"""
US/KS-Courts -- Kansas State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.KS-Courts")
...
class KSCourtsScraper(BaseScraper):
    """Scraper for US/KS-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "KSCT")
        doc_id = f"US-KS-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Kansas Court"))
        return {
            "_id": doc_id,
            "_source": "US/KS-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/KS-Courts data fetcher")
