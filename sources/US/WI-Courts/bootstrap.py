#!/usr/bin/env python3
"""
US/WI-Courts -- Wisconsin Supreme Court
...
class WICourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/WI-Courts'
    COURT_ORDER = ['wis', 'wisctapp']
    COURT_NAMES = {
    ...
    def doc_id_for(self, court_id, cluster_id):
        ...
        return f"wi-{cluster_id}"


if __name__ == "__main__":
    run_cli(WICourtsScraper)
