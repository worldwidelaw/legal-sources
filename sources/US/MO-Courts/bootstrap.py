#!/usr/bin/env python3
"""
US/MO-Courts -- Missouri State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.MO-Courts")
...
class MOCourtsScraper(BaseScraper):
    """Scraper for US/MO-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "MOCT")
        doc_id = f"US-MO-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Missouri Court"))
        return {
            "_id": doc_id,
            "_source": "US/MO-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/MO-Courts data fetcher")
