#!/usr/bin/env python3
"""
US/AR-Courts -- Arkansas State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.AR-Courts")
...
class ARCourtsScraper(BaseScraper):
    """Scraper for US/AR-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "ARCT")
        doc_id = f"US-AR-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Arkansas Court"))
        return {
            "_id": doc_id,
            "_source": "US/AR-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/AR-Courts data fetcher")
