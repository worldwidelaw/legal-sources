#!/usr/bin/env python3
"""
US/VA-Courts -- Virginia State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.VA-Courts")
...
class VACourtsScraper(BaseScraper):
    """Scraper for US/VA-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "VACT")
        doc_id = f"US-VA-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Virginia Court"))
        return {
            "_id": doc_id,
            "_source": "US/VA-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/VA-Courts data fetcher")
