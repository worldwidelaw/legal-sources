#!/usr/bin/env python3
"""
US/DC-Courts -- District of Columbia State Court Opinions
...
Courts covered:
  ...
  - District of Columbia Court of Appeals (dcctapp)
...
logger = logging.getLogger("legal-data-hunter.US.DC-Courts")
...
COURT_NAMES = {
    ...
    "dcctapp": "District of Columbia Court of Appeals"
}
...
class DCCourtsScraper(BaseScraper):
    """Scraper for US/DC-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "DCCT")
        doc_id = f"US-DC-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "District of Columbia Court"))
        return {
            "_id": doc_id,
            "_source": "US/DC-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/DC-Courts data fetcher")
