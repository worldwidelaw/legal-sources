#!/usr/bin/env python3
"""
US/SD-Courts -- South Dakota State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.SD-Courts")
...
class SDCourtsScraper(BaseScraper):
    """Scraper for US/SD-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "SDCT")
        doc_id = f"US-SD-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "South Dakota Court"))
        return {
            "_id": doc_id,
            "_source": "US/SD-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/SD-Courts data fetcher")
