#!/usr/bin/env python3
"""
US/AK-Courts -- Supreme Court of Alaska
...
class AKCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/AK-Courts'
    COURT_ORDER = ['alaska', 'alaskactapp']
    COURT_NAMES = {
