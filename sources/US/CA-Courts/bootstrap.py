#!/usr/bin/env python3
"""
US/CA-Courts -- Supreme Court of California
...
class CACourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/CA-Courts'
    COURT_ORDER = ['cal', 'calctapp', 'calsuperct']
    COURT_NAMES = {
