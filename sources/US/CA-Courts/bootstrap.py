#!/usr/bin/env python3
"""
US/CA-Courts -- California State Court Opinions
...
Courts covered:
  ...
  - Court of Appeal of California (calctapp)
...
logger = logging.getLogger("legal-data-hunter.US.CA-Courts")
...
class CACourtsScraper(BaseScraper):
    """Scraper for US/CA-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "CACT")
        doc_id = f"US-CA-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "California Court"))
        return {
            "_id": doc_id,
            "_source": "US/CA-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/CA-Courts data fetcher")
