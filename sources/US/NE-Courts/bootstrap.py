...
logger = logging.getLogger("legal-data-hunter.US.NE-Courts")
...
COURT_NAMES = {
    ...
    "nebctapp": "Court of Appeals of Nebraska"
}
...
class NECourtsScraper(BaseScraper):
    """Scraper for US/NE-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NECT")
        doc_id = f"US-NE-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Nebraska Court"))
        return {
            "_id": doc_id,
            "_source": "US/NE-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/NE-Courts data fetcher")
