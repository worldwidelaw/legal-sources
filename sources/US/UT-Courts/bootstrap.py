#!/usr/bin/env python3
"""
US/UT-Courts -- Utah Supreme Court
...
class UTCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/UT-Courts'
    COURT_ORDER = ['utah', 'utahctapp']
    COURT_NAMES = {
    ...
    def doc_id_for(self, court_id, cluster_id):
        ...
        return f"ut-{cluster_id}"


if __name__ == "__main__":
    run_cli(UTCourtsScraper)
