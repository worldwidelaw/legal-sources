...
logger = logging.getLogger("legal-data-hunter.US.NM-Courts")
...
class NMCourtsScraper(BaseScraper):
    """Scraper for US/NM-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NMCT")
        doc_id = f"US-NM-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "New Mexico Court"))
        return {
            "_id": doc_id,
            "_source": "US/NM-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/NM-Courts data fetcher")
