#!/usr/bin/env python3
"""
US/ME-Courts -- Maine State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.ME-Courts")
...
class MECourtsScraper(BaseScraper):
    """Scraper for US/ME-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "MECT")
        doc_id = f"US-ME-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Maine Court"))
        return {
            "_id": doc_id,
            "_source": "US/ME-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/ME-Courts data fetcher")
