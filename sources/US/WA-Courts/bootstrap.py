#!/usr/bin/env python3
"""
US/WA-Courts -- Supreme Court of Washington
...
class WACourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/WA-Courts'
    COURT_ORDER = ['wash', 'washctapp']
    COURT_NAMES = {
