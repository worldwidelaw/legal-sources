...
class WACourtsScraper(BaseScraper):
    """Scraper for US/WA-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "WACT")
        doc_id = f"US-WA-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Washington Court"))
        return {
            "_id": doc_id,
            "_source": "US/WA-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/WA-Courts data fetcher")
