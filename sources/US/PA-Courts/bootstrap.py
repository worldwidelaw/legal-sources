#!/usr/bin/env python3
"""
US/PA-Courts -- Pennsylvania State Court Opinions
...
Courts covered:
  ...
  - Court of Judicial Discipline of Pennsylvania (cjdpa)
...
logger = logging.getLogger("legal-data-hunter.US.PA-Courts")

SEARCH_URL = "https://www.courtlistener.com/api/rest/v4/search/"
STORAGE_BASE = "https://storage.courtlistener.com/"
USER_AGENT = "LegalDataHunter/1.0 (legal research; open data collection)"

COURTS = "pa,pasuperct,pacommwct,cjdpa"
...
class PACourtsScraper(BaseScraper):
    """Scraper for US/PA-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "PACT")
        doc_id = f"US-PA-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Pennsylvania Court"))
        return {
            "_id": doc_id,
            "_source": "US/PA-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/PA-Courts data fetcher")
