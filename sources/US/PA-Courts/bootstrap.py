#!/usr/bin/env python3
"""
US/PA-Courts -- Supreme Court of Pennsylvania
...
class PACourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/PA-Courts'
    COURT_ORDER = ['pa', 'pasuperct', 'pacommwct', 'cjdpa']
    COURT_NAMES = {
