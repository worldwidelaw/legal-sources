#!/usr/bin/env python3
"""
US/MS-Courts -- Mississippi State Court Opinions
...
class MSCourtsScraper(BaseScraper):
    """Scraper for US/MS-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "MSCT")
        doc_id = f"US-MS-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Mississippi Court"))
        return {
            "_id": doc_id,
            "_source": "US/MS-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/MS-Courts data fetcher")
