#!/usr/bin/env python3
"""
US/OR-Courts -- Supreme Court of Oregon
...
class ORCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/OR-Courts'
    COURT_ORDER = ['or', 'orctapp', 'ortc']
    COURT_NAMES = {
