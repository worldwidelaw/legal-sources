...
class ORCourtsScraper(BaseScraper):
    """Scraper for US/OR-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "ORCT")
        doc_id = f"US-OR-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Oregon Court"))
        return {
            "_id": doc_id,
            "_source": "US/OR-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/OR-Courts data fetcher")
