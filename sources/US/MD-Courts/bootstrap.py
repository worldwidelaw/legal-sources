#!/usr/bin/env python3
"""
US/MD-Courts -- Supreme Court of Maryland
...
class MDCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/MD-Courts'
    COURT_ORDER = ['md', 'mdctspecapp']
    COURT_NAMES = {
