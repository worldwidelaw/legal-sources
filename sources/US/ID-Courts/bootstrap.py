...
class IDCourtsScraper(BaseScraper):
    """Scraper for US/ID-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "IDCT")
        doc_id = f"US-ID-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Idaho Court"))
        return {
            "_id": doc_id,
            "_source": "US/ID-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/ID-Courts data fetcher")
