#!/usr/bin/env python3
"""
US/ID-Courts -- Supreme Court of Idaho
...
class IDCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/ID-Courts'
    COURT_ORDER = ['idaho', 'idahoctapp']
    COURT_NAMES = {
