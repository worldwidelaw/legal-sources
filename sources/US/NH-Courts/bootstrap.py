#!/usr/bin/env python3
"""
US/NH-Courts -- New Hampshire State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.NH-Courts")
...
class NHCourtsScraper(BaseScraper):
    """Scraper for US/NH-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NHCT")
        doc_id = f"US-NH-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "New Hampshire Court"))
        return {
            "_id": doc_id,
            "_source": "US/NH-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/NH-Courts data fetcher")
