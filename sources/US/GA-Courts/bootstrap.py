#!/usr/bin/env python3
"""
US/GA-Courts -- Supreme Court of Georgia
...
class GACourtsScraper(OpinionKeyedCourtListenerScraper):
    SOURCE_ID = 'US/GA-Courts'
    COURT_ORDER = ['ga', 'gactapp']
    COURT_NAMES = {
    ...
    OPINION_ID_PREFIX = 'ga-courts'
    JURISDICTION = 'US-GA'


if __name__ == "__main__":
    run_cli(GACourtsScraper)
