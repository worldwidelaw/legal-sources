#!/usr/bin/env python3
"""
US/RI-Courts -- Rhode Island State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.RI-Courts")
...
class RICourtsScraper(BaseScraper):
    """Scraper for US/RI-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "RICT")
        doc_id = f"US-RI-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Rhode Island Court"))
        return {
            "_id": doc_id,
            "_source": "US/RI-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/RI-Courts data fetcher")
