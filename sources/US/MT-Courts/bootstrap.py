#!/usr/bin/env python3
"""
US/MT-Courts -- Montana State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.MT-Courts")
...
class MTCourtsScraper(BaseScraper):
    """Scraper for US/MT-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "MTCT")
        doc_id = f"US-MT-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Montana Court"))
        return {
            "_id": doc_id,
            "_source": "US/MT-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/MT-Courts data fetcher")
