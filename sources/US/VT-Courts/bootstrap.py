#!/usr/bin/env python3
"""
US/VT-Courts -- Vermont State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.VT-Courts")
...
class VTCourtsScraper(BaseScraper):
    """Scraper for US/VT-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "VTCT")
        doc_id = f"US-VT-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Vermont Court"))
        return {
            "_id": doc_id,
            "_source": "US/VT-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/VT-Courts data fetcher")
