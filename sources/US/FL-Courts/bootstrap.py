#!/usr/bin/env python3
"""
US/FL-Courts -- Florida State Court Opinions
...
class FLCourtsScraper(BaseScraper):
    """Scraper for US/FL-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "FLCT")
        doc_id = f"US-FL-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Florida Court"))
        return {
            "_id": doc_id,
            "_source": "US/FL-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/FL-Courts data fetcher")
