#!/usr/bin/env python3
"""
US/DE-Courts -- Supreme Court of Delaware
...
class DECourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/DE-Courts'
    COURT_ORDER = ['del', 'delch', 'delsuperct', 'delctcompl']
    COURT_NAMES = {
