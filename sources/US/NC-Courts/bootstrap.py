#!/usr/bin/env python3
"""
US/NC-Courts -- Supreme Court of North Carolina
...
class NCCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/NC-Courts'
    COURT_ORDER = ['nc', 'ncctapp']
    COURT_NAMES = {
    ...
    def doc_id_for(self, court_id, cluster_id):
        ...
        return f"nc-{cluster_id}"


if __name__ == "__main__":
    run_cli(NCCourtsScraper)
