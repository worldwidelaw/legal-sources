...
logger = logging.getLogger("legal-data-hunter.US.WY-Courts")
...
class WYCourtsScraper(BaseScraper):
    """Scraper for US/WY-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "WYCT")
        doc_id = f"US-WY-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Wyoming Court"))
        return {
            "_id": doc_id,
            "_source": "US/WY-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/WY-Courts data fetcher")
