#!/usr/bin/env python3
"""
US/IA-Courts -- Iowa State Court Opinions
...
class IACourtsScraper(BaseScraper):
    """Scraper for US/IA-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "IACT")
        doc_id = f"US-IA-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Iowa Court"))
        return {
            "_id": doc_id,
            "_source": "US/IA-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/IA-Courts data fetcher")
