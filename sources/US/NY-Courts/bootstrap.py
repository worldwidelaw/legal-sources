#!/usr/bin/env python3
"""
US/NY-Courts -- New York State Court Opinions

Fetches case law via CourtListener's public search API (no auth needed),
then downloads opinion PDFs and extracts full text.

Courts covered:
  - Court of Appeals of New York (ny)
  - Appellate Division of the Supreme Court of New York (nyappdiv)
  - Appellate Term of the Supreme Court of New York (nyappterm)
  - Supreme Court of New York (nysupct)
  - Family Court of New York (nyfamct)
...
logger = logging.getLogger("legal-data-hunter.US.NY-Courts")

SEARCH_URL = "https://www.courtlistener.com/api/rest/v4/search/"
STORAGE_BASE = "https://storage.courtlistener.com/"
USER_AGENT = "LegalDataHunter/1.0 (legal research; open data collection)"

COURTS = "ny,nyappdiv,nyappterm,nysupct,nyfamct,nycivct,nycrimct"
...
class NYCourtsScraper(BaseScraper):
    """Scraper for US/NY-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NYCT")
        doc_id = f"US-NY-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "New York Court"))
        return {
            "_id": doc_id,
            "_source": "US/NY-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/NY-Courts data fetcher")
