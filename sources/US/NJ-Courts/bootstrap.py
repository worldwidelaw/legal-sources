#!/usr/bin/env python3
"""
US/NJ-Courts -- New Jersey State Court Opinions
...
Courts covered:
  ...
  - Superior Court of New Jersey, Appellate Division (njsuperctappdiv)
...
logger = logging.getLogger("legal-data-hunter.US.NJ-Courts")

SEARCH_URL = "https://www.courtlistener.com/api/rest/v4/search/"
STORAGE_BASE = "https://storage.courtlistener.com/"
USER_AGENT = "LegalDataHunter/1.0 (legal research; open data collection)"

COURTS = "nj,njsuperctappdiv,njtaxct"
...
class NJCourtsScraper(BaseScraper):
    """Scraper for US/NJ-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NJCT")
        doc_id = f"US-NJ-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "New Jersey Court"))
        return {
            "_id": doc_id,
            "_source": "US/NJ-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/NJ-Courts data fetcher")
