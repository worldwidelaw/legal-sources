...
logger = logging.getLogger("legal-data-hunter.US.HI-Courts")
...
COURT_NAMES = {
    ...
    "hawapp": "Intermediate Court of Appeals of Hawaii"
}
...
class HICourtsScraper(BaseScraper):
    """Scraper for US/HI-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "HICT")
        doc_id = f"US-HI-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Hawaii Court"))
        return {
            "_id": doc_id,
            "_source": "US/HI-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/HI-Courts data fetcher")
