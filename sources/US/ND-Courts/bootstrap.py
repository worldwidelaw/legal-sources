#!/usr/bin/env python3
"""
US/ND-Courts -- Supreme Court of North Dakota
...
class NDCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/ND-Courts'
    COURT_ORDER = ['nd', 'ndctapp']
    COURT_NAMES = {
