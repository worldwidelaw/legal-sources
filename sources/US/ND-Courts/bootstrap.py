#!/usr/bin/env python3
"""
US/ND-Courts -- North Dakota State Court Opinions
...
Courts covered:
  ...
  - Court of Appeals of North Dakota (ndctapp)
...
logger = logging.getLogger("legal-data-hunter.US.ND-Courts")
...
class NDCourtsScraper(BaseScraper):
    """Scraper for US/ND-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "NDCT")
        doc_id = f"US-ND-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "North Dakota Court"))
        return {
            "_id": doc_id,
            "_source": "US/ND-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/ND-Courts data fetcher")
