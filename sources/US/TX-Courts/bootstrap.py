#!/usr/bin/env python3
"""
US/TX-Courts -- Texas State Court Opinions
...
class TXCourtsScraper(BaseScraper):
    """Scraper for US/TX-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "TXCT")
        doc_id = f"US-TX-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Texas Court"))
        return {
            "_id": doc_id,
            "_source": "US/TX-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/TX-Courts data fetcher")
