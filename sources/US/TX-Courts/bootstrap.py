#!/usr/bin/env python3
"""
US/TX-Courts -- Supreme Court of Texas
...
class TXCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/TX-Courts'
    COURT_ORDER = ['tex', 'texapp', 'texcrimapp']
    COURT_NAMES = {
