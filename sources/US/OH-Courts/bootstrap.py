#!/usr/bin/env python3
"""
US/OH-Courts -- Ohio Supreme Court
...
class OHCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/OH-Courts'
    COURT_ORDER = ['ohio', 'ohioctapp']
    COURT_NAMES = {
    ...
    def doc_id_for(self, court_id, cluster_id):
        ...
        return f"{self.ID_PREFIX}-{court_id or 'ohio'}-{cluster_id}"


if __name__ == "__main__":
    run_cli(OHCourtsScraper)
