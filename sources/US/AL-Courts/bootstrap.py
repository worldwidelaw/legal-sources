#!/usr/bin/env python3
"""
US/AL-Courts -- Alabama State Court Opinions
...
logger = logging.getLogger("legal-data-hunter.US.AL-Courts")

SEARCH_URL = "https://www.courtlistener.com/api/rest/v4/search/"
STORAGE_BASE = "https://storage.courtlistener.com/"
USER_AGENT = "LegalDataHunter/1.0 (legal research; open data collection)"

COURTS = "ala,alacivapp,alacrimapp"
...
class ALCourtsScraper(BaseScraper):
    """Scraper for US/AL-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "ALCT")
        doc_id = f"US-AL-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Alabama Court"))
        return {
            "_id": doc_id,
            "_source": "US/AL-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/AL-Courts data fetcher")
