#!/usr/bin/env python3
"""
US/AL-Courts -- Supreme Court of Alabama
...
class ALCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/AL-Courts'
    COURT_ORDER = ['ala', 'alacivapp', 'alacrimapp']
    COURT_NAMES = {
