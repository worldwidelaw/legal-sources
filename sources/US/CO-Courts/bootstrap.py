#!/usr/bin/env python3
"""
US/CO-Courts -- Colorado State Court Opinions
...
Courts covered:
  ...
  - Court of Appeals of Colorado (coloctapp)
...
class COCourtsScraper(BaseScraper):
    """Scraper for US/CO-Courts via CourtListener API."""
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_abbr = COURT_ABBRS.get(court_id, "COCT")
        doc_id = f"US-CO-{court_abbr}-{cluster_id}"
        court_name = COURT_NAMES.get(court_id, raw.get("court", "Colorado Court"))
        return {
            "_id": doc_id,
            "_source": "US/CO-Courts",
            "_type": "case_law",
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="US/CO-Courts data fetcher")
