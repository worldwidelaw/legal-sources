#!/usr/bin/env python3
"""
US/CO-Courts -- Supreme Court of Colorado
...
class COCourtsScraper(CourtListenerScraper):
    SOURCE_ID = 'US/CO-Courts'
    COURT_ORDER = ['colo', 'coloctapp']
    COURT_NAMES = {
