#!/usr/bin/env python3
"""
US/MI-Courts -- Michigan Supreme Court
...
class MICourtsScraper(OpinionKeyedCourtListenerScraper):
    SOURCE_ID = 'US/MI-Courts'
    COURT_ORDER = ['mich', 'michctapp']
    COURT_NAMES = {
    ...
    OPINION_ID_PREFIX = 'mi-courts'
    JURISDICTION = 'US-MI'


if __name__ == "__main__":
    run_cli(MICourtsScraper)
